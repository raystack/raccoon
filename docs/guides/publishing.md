...
Refer to the [Event.proto](https://github.com/odpf/proton/blob/main/odpf/raccoon/v1beta1/raccoon.proto) for how the event could be composed of.
...
Refer to the [raccoon.proto](https://github.com/odpf/proton/blob/main/odpf/raccoon/v1beta1/raccoon.proto) that Raccoon sends for every event.
...
Input to the RPC call is [SendEventRequest](https://github.com/odpf/proton/blob/main/odpf/raccoon/v1beta1/raccoon.proto) and the output is [raccoon.proto](https://github.com/odpf/proton/blob/main/odpf/raccoon/v1beta1/raccoon.proto).
