...
type buffer struct {
	...
	ChannelSize int `mapstructure:"channel_size" cmdx:"worker.buffer.channel.size" default:"100"`
	...
	FlushTimeoutMS int64 `mapstructure:"flush_timeout_ms" cmdx:"worker.buffer.flush.timeout.ms" default:"5000"`
}

type worker struct {
	// WorkersPoolSize number of worker to push to kafka initiated at the start of Raccoon
	PoolSize int    `mapstructure:"pool_size" cmdx:"worker.pool.size" default:"5"`
