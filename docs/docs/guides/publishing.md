...
Refer to [raccoon.proto](https://github.com/raystack/proton/blob/main/raystack/raccoon/v1beta1/raccoon.proto) to learn how you can build the request.
...
* **events** - events of type Event proto. Refer to the [raccoon.proto](https://github.com/raystack/proton/blob/main/raystack/raccoon/v1beta1/raccoon.proto) to learn more.
...
| events.type       | string        | Event type which Raccoon uses to distribute the events to topics       |
