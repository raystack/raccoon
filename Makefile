...
generate-proto:
	...
	protoc --proto_path=.temp/ .temp/odpf/raccoon/v1/raccoon.proto --go_out=./ --go_opt=paths=import --go_opt=Modpf/raccoon/v1/raccoon.proto=$(PROTO_PACKAGE)
	protoc --proto_path=.temp/ .temp/odpf/raccoon/v1/raccoon.proto  --go-grpc_opt=paths=import --go-grpc_opt=Modpf/raccoon/v1/raccoon.proto=$(PROTO_PACKAGE) --go-grpc_out=./
