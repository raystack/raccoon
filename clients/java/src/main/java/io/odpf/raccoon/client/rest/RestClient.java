package io.odpf.raccoon.client.rest;
...
public class RestClient implements RaccoonClient {
     ...
     */
    @Override
    public Result<Response> send(Event[] events) {
        ...
        try {
            ...
            return Result.<Response>builder().isSuccess(true)
                    .reqGuid(reqGuid)
        ...
        return Result.<Response>builder()
                .isSuccess(false)
                .reqGuid(reqGuid)
