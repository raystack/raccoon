...
Refer to [SendEventRequest.proto](https://github.com/odpf/proton/blob/main/odpf/raccoon/SendEventRequest.proto) for how you can build the request.
...
Refer to the [SendEventResponse.proto](https://github.com/odpf/proton/blob/main/odpf/raccoon/SendEventResponse.proto) that Raccoon sends for every event.
...
Refer to [EventService.proto](https://github.com/odpf/proton/blob/main/odpf/raccoon/EventService.proto) for the definition of `EventService` which exposes one RPC call `SendEvent`. It is recommended to generate the language specific gRPC client using the proto definition.

Input to the RPC call is [SendEventRequest.proto](https://github.com/odpf/proton/blob/main/odpf/raccoon/SendEventRequest.proto) and the output is [SendEventResponse.proto](https://github.com/odpf/proton/blob/main/odpf/raccoon/SendEventResponse.proto).
